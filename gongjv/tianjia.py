...
try:
    ...
    if v1 > v2:
        ...
        os.system("cp -r "+SheBei_LuJing+"/mp3/xiangsheng/* "+BenDi_LuJing+"/mp3/xiangsheng/")
        ...
        os.system("cp -r "+SheBei_LuJing+"/mp3/jiangtan/* "+BenDi_LuJing+"/mp3/jiangtan/")
